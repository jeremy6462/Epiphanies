...
/*!
 ...
 @discussion custome zones are used to help organize data in a CloudKit database. I am using them so that I can use their push notification update to clients that data on the private database for their user was updated, changed, or added. If block is nil,nil,nil then the zone was already saved
